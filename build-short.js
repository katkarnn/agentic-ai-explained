...
(async () => {
  ...
  // ================================================= SLIDE 23 — 5 PATTERNS OVERVIEW
  {
    ...
    lead(s, "Almost every “agentic” product is one of these five — or a mix of them.", 1.9, MUTED);
    const pats = [
  ...
  await pres.writeFile({ fileName: path.join(__dirname, "Agentic-AI-Explained-Short.pptx") });
  console.log("done (SHORT) — " + TOTAL + " slides");
})();
